    ...
    return (
      <section className="px-4 lg:px-16 grid grid-cols-1 md:grid-cols-4 lg:grid-cols-8 mt-8 md:mt-4 gap-4 md:gap-x-4">
        <div className="col-span-1 mt-35 md:mt-0 md:col-span-2 mb-4 md:mb-0">
          <h1 className="text-3xl sm:text-4xl font-semibold md:text-5xl lg:text-6xl lg:font-bold">Casual Inspirations</h1>
          ...
          <button className="mt-4 md:mt-8 text-center w-full h-10 md:h-12 rounded-full border border-black flex items-center justify-center text-sm sm:text-base sm:md:lg:hover:bg-black hover:text-white cursor-pointer ">
            BROWSE INPIRATIONS
          </button>
        </div>
